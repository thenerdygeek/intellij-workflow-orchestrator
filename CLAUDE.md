...
| `:agent` | AI coding agent — ReAct loop, 110 tools (67 registered, 15 meta-tools), agent tool for subagent spawning, plan persistence, JCEF chat UI, real-time steering |
