/**
 * QuestionFlow — multi-step questionnaire with progressive, upfront, and receipt modes.
...
export interface QuestionFlowStepDefinition {
  ...
  title: string;
  description?: string;
  options: Omit<QuestionFlowOption, "icon">[];
...
export interface QuestionFlowProgressiveProps extends BaseRuntimeProps {
  id: string;
...
export interface QuestionFlowUpfrontProps extends BaseRuntimeProps {
  id: string;
  role?: "information" | "decision" | "control" | "state" | "composite";
...
export interface QuestionFlowReceiptProps extends BaseRuntimeProps {
  id: string;
  role?: "information" | "decision" | "control" | "state" | "composite";
...
function QuestionFlowUpfront({
  ...
  // steps is guaranteed non-empty by the type constraint
