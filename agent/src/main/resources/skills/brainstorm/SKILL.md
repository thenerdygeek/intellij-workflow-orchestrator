---
name: brainstorm
description: Turn an idea into a fully formed design through collaborative dialogue before any code — use proactively before any non-trivial implementation. Triggers: 'brainstorm', 'design', 'how should I', "let's plan", 'I want to add/build', 'new feature', 'architecture/approach for'. Don't skip for features, components, or architectural changes even if the answer seems obvious.
user-invocable: true
