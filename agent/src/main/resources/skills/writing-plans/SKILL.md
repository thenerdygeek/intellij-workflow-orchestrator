---
name: writing-plans
description: Create structured, reviewable implementation plans (bite-sized tasks, acceptance criteria, file-level guidance) before any code. Load AFTER enable_plan_mode. Triggers: 'plan this', 'create/write a plan', 'how should I implement', or proactively when the task touches 2+ files, crosses modules, adds features/endpoints, or needs non-trivial multi-step work. Not for single-file fixes or simple questions.
user-invocable: true
