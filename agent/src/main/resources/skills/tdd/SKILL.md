---
name: tdd
description: Disciplined red-green-refactor TDD: write the failing test first from requirements, then minimal code to pass, then refactor. Triggers: 'TDD', 'test first', 'test-driven', 'write tests for', 'add tests', 'test this', 'cover with tests', new functionality needing coverage, or bugfixes needing a regression test. Not for exploratory changes with unclear requirements.
user-invocable: true
