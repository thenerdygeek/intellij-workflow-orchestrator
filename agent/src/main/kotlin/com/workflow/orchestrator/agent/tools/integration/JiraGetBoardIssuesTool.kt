...
class JiraGetBoardIssuesTool : AgentTool {
    override val name = "jira_get_board_issues"
    override val description = "Get unresolved issues on a Jira board. Shows ticket key, summary, status, assignee, and priority."
    ...
    override suspend fun execute(params: JsonObject, project: Project): ToolResult {
        ...
        return service.getBoardIssues(boardId).toAgentToolResult()
    }
}
