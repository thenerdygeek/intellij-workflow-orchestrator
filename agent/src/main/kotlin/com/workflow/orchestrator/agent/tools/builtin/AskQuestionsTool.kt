...
class AskQuestionsTool : AgentTool {
    ...
    override fun documentation(): ToolDocumentation = toolDoc("ask_followup_question") {
        ...
        related("think", Relationship.COMPLEMENT, "If you're tempted to ask a trivial question, run think first — often the answer is derivable from existing context and a question is unnecessary.")
