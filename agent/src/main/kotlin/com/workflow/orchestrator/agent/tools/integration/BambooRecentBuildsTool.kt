...
class BambooRecentBuildsTool : AgentTool {
    override val name = "bamboo_recent_builds"
    override val description = "Get recent build results for a Bamboo plan. Returns up to maxResults builds with state, duration, and test info."
    ...
    override suspend fun execute(params: JsonObject, project: Project): ToolResult {
        ...
        return service.getRecentBuilds(planKey, maxResults, repoName = repoName).toAgentToolResult()
    }
}
