...
class BitbucketDeclinePrTool : AgentTool {
    override val name = "bitbucket_decline_pr"
    override val description = "Decline (close without merging) a Bitbucket pull request."
    ...
    override suspend fun execute(params: JsonObject, project: Project): ToolResult {
        ...
        return service.declinePullRequest(prId, repoName = repoName).toAgentToolResult()
    }
}
