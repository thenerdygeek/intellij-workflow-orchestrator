...
class BambooGetPlanVariablesTool : AgentTool {
    override val name = "bamboo_get_plan_variables"
    override val description = "Get configured variables for a Bamboo plan. Shows variable names and default values."
    ...
    override suspend fun execute(params: JsonObject, project: Project): ToolResult {
        ...
        return service.getPlanVariables(planKey).toAgentToolResult()
    }
}
