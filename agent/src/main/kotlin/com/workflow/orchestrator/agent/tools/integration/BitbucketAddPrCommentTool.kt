...
class BitbucketAddPrCommentTool : AgentTool {
    override val name = "bitbucket_add_pr_comment"
    override val description = "Add a general comment to a Bitbucket pull request."
    override val parameters = FunctionParameters(
        ...
        required = listOf("pr_id", "text", "description")
    )
    ...
    override suspend fun execute(params: JsonObject, project: Project): ToolResult {
        ...
        return service.addPrComment(prId, text, repoName = repoName).toAgentToolResult()
    }
}
