...
class BambooGetBuildLogTool : AgentTool {
    override val name = "bamboo_get_build_log"
    override val description = "Get the build log for a Bamboo build. Useful for diagnosing build failures."
    ...
    override suspend fun execute(params: JsonObject, project: Project): ToolResult {
        ...
        return service.getBuildLog(buildKey).toAgentToolResult()
    }
}
