...
class SubagentAutoApproveWiringTest {
    @Test fun `SubagentRunner forwards allowlist + toggle into its AgentLoop`() {
        ...
        assertTrue(
            ...
            "SubagentRunner must accept + forward sessionCommandAllowlist",
        )
        assertTrue(
            src.contains("autoApproveSafeCommands"),
            "SubagentRunner must accept + forward autoApproveSafeCommands",
        )
    }
