...
class FindImplementationsToolSmartModeTest {
    ...
    @Test
    fun `find_implementations does not eagerly bail when indexer is busy`() = runTest {
        ...
        val tool = FindImplementationsTool(registry)

        val params = buildJsonObject {
            put("method", "NonExistentMethod")
            put("path", "Foo.java")
        }
