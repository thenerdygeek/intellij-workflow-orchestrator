...
class TikaXhtmlFormatGapsTest {
    ...
    @Test
    fun `the entire DocumentBlock sealed hierarchy has 11 variants — that is the expressivity ceiling`() {
        ...
        assertEquals(
            ...
            variants,
            "Any feature that doesn't fit one of these 11 variants is invisible to the LLM. " +
