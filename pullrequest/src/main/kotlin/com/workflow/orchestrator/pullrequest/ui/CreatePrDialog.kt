 ...
 *
 *  Description starts empty — the user clicks Generate to produce one. (The previous
 *  `autoGenerateDescription` flag was tied to the Build-tab Create PR entry point, which
 *  was removed alongside the PrBar redesign.)
 */
class CreatePrDialog(
    ...
    init {
        ...
        // Description starts empty; user clicks Generate to produce one. (The Build-tab
        // auto-generate-on-open path was removed when the Create-PR entry point on the
        // Build tab was deleted as part of the PrBar redesign.)
