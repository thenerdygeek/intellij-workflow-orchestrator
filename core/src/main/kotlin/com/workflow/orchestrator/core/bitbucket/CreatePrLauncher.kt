...
interface CreatePrLauncher {
     ...
     *
     * The dialog opens with an empty description; the user clicks Generate to
     * produce one. (The previous Build-tab `autoGenerateDescription = true` path
     * was removed alongside the Build-tab "+ Create PR" entry point.)
     *
