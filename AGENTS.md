...
- Update the relevant module-level `AGENTS.md` file
- Update `docs/architecture/` diagrams and docs (including `index.html`)
- Update this root `AGENTS.md` if it affects build commands, module list, threading rules, or UX constraints
...
- API details: see module-level AGENTS.md files
